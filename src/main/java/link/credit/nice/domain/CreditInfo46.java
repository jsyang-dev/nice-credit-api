...
/**
 * 전문 - "개인계좌별 대출정보내역 (연합회) Bitmap(46)"
 */
@Entity
@Table(name = "TF_CRE_CREDIT_INFO_46")
@Getter
@Setter
@SuperBuilder
@NoArgsConstructor
@AllArgsConstructor
@AttributeOverride(name = "no", column = @Column(name = "CREDIT_INFO_46_NO"))
@ToString
public class CreditInfo46 extends BaseEntity {
