...
/**
 * 전문 - "채무보증 정보내역 (연합회) Bitmap(24)"
 */
@Entity
@Table(name = "TF_CRE_CREDIT_INFO_24")
@Getter
@Setter
@SuperBuilder
@NoArgsConstructor
@AllArgsConstructor
@AttributeOverride(name = "no", column = @Column(name = "CREDIT_INFO_24_NO"))
@ToString
public class CreditInfo24 extends BaseEntity {
